...
- `release/xw-mindmap-agent-skill-0.1.5.tgz`
...
mkdir -p release
tar -czf release/xw-mindmap-agent-skill-0.1.5.tgz -C agent-skills xw-mindmap install-xw-mindmap.sh
...
```bash
tar -tzf release/xw-mindmap-agent-skill-0.1.5.tgz
...
```bash
git tag xw-mindmap-skill-v0.1.5
git push xw xw-mindmap-skill-v0.1.5
```
...
```text
xw-mindmap Agent Skill v0.1.5
```

Suggested release notes:

```markdown
xw-mindmap agent Skill v0.1.5 release.
